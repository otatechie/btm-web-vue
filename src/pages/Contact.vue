        ...
        <div class="w-full flex justify-center pb-10 px-4">
            <div class="w-full max-w-4xl">
                <section
                    ...
                    <div class="flex-1 flex flex-col items-start justify-center p-10 transition hover:bg-gray-50 focus-within:bg-gray-50"
                        ...
                        <a href="mailto:info.gh@btmlimited.net"
                            class="text-gray-700 font-medium text-md mb-1 underline hover:text-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 rounded"
                    ...
                    <div class="flex-1 flex flex-col items-start justify-center p-10 transition hover:bg-gray-50 focus-within:bg-gray-50"
                        ...
                        <div class="flex items-center mb-2">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="h-5 w-5 text-blue-500 mr-2" aria-hidden="true">
                        ...
                        <div class="text-blue-700 font-medium text-md mb-1">
                            <a href="tel:+233302743234"
                                class="underline hover:text-blue-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 rounded"
                                aria-label="Call +233(0)-302-743-234">+233(0)-302-743-234</a><br>
                            <a href="tel:+233303980144"
                                class="underline hover:text-blue-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 rounded"
            ...
            <div class="w-full max-w-4xl">
                <div class="rounded-xl overflow-hidden border border-gray-200 shadow-md">
                    <iframe width="100%" height="400"
                        ...
                        class="w-full h-[400px] border-0" allowfullscreen title="BTM Ghana Limited Location Map"
                        aria-label="Interactive map showing BTM Ghana Limited location"></iframe>
                </div>
            </div>
        </div>
    </main>
